...
\paragraph{}Hey Siri.
\mainmatter
\include{SpeechSignalProcessing}
\include{ShortTimeProcessing}
\include{Probability}
\include{PatternRecognition}

\begin{thebibliography}{42}
    \bibitem{IDSP} Rabiner, Lawrence R., and Ronald W. Schafer. \textit{Introduction to digital speech processing}. Vol. 1. Now Publishers Inc, 2007.
    \bibitem{TADSP} Rabiner, Lawrence, and Ronald Schafer. \textit{Theory and applications of digital speech processing}. Prentice Hall Press, 2010.
\end{thebibliography}
